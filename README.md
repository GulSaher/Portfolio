...
### 🚀 Network Engineer | AWS Cloud Architect | GenAI Developer
Experienced IT professional transitioning from traditional Networking (**CCNA/CCNP**) to **Cloud Infrastructure** and **AI Automation**. I build scalable AWS environments and custom Generative AI applications.

---

### 🛠️ Technical Toolkit
*   **Cloud & AI:** AWS (EC2, S3, RDS, Bedrock), Generative AI Integration, Custom AI Apps.
*   **Networking:** Cisco CCNA/CCNP (Routing & Switching), Network Automation, Troubleshooting.
